        ...
        try {
          ...
          function ask_question(qu) {
            ...
            user.send({embeds: [new Discord.MessageEmbed()
                ...
                .setDescription(qu)
                .setAuthor(`Question ${counter + 1} / ${Questions.length}`, client.user.displayAvatarURL(), "https://discord.com/api/oauth2/authorize?client_id=&permissions=8&scope=bot%20applications.commands")
                .setFooter(es.footertext, es.footericon)
            ]}).then(msg => {
