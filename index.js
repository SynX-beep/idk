...
client.azury = `https://discord.gg/Azury`; // Credits for the bot Owner: Maserious
 ...
 *********************************************************/
/* const Enmap = require("enmap")
client.afkDB = new Enmap({name: "afkDB", dataDir: "./databases/afkDB"})
client.mutes = new Enmap({name: "mutes", dataDir: "./databases/mutes"})
client.setups = new Enmap({name: "setups", dataDir: "./databases/setups"})
client.jtcsettings = new Enmap({name: "jtcsettings", dataDir: "./databases"}) */