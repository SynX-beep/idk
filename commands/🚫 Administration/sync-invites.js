...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      .addComponents([
new MessageButton().setStyle('SUCCESS').setCustomId('1').setEmoji("833101995723194437").setLabel("YES DO IT!"),
      new MessageButton().setStyle('PRIMARY').setCustomId('2').setEmoji("833101993668771842").setLabel("Cancel"),
      ...
      ],components: [row]});//create a collector for the thinggy
