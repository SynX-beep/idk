    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Ghost-Ping-Detector Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/bookmark_1f516.png', 'https://discord.gg/Azury')
                  ...
                  if (channel) {
                    try {
                      ...
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`${client.emoji.yes} I will now send all detected Ghost Pings in \`${channel.name}\``)
                        .setColor(es.color)
          ...
          case "Disable Detector-Log":
            {
              ...
              return message.reply({embeds: [new Discord.MessageEmbed()
                .setTitle(`${client.emoji.yes} Successfully disabled the Ghost-Ping-Detector System & Log`)
                .setColor(es.color)
                .setFooter(es.footertext, es.footericon)]}
              );
            }
