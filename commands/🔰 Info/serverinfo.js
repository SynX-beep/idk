...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      embed.addField(client.la[ls].cmds.info.serverinfo.field12, "<:NitroGift:933711012799062017> \`" + message.guild.premiumSubscriptionCount + "\`", true)
      ...
      if(boosts >= 14){
          embed.addField(`**<:a_right:933701797032361984> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<:no:933239221836206131> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<:a_right:933701797032361984> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<:a_right:933701797032361984> SERVER DISCOVERY SPLASH:**`)
