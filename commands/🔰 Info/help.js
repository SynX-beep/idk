  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("930608434603262045").setLabel("Support").setURL("https://discord.gg/notsaksh")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
        ...
        let menuSelection = new MessageSelectMenu()
          ...
          .setPlaceholder("Click me to view Help-Category-Pages")
          .setMinValues(1)
          .setMaxValues(5)
...
<:Discord:933249753955860490> Made by [**Topical Development**](https://discord.gg/notsaksh)`)
.addField("How to get help?", `>>> **\` 1. Way \`** *Use the Buttons, to swap the Pages*\n**\` 2. Way \`** *Use the Menu to select all Help Pages, you want to display*\n**\` 3. Way \`** *Watch the Youtube Tutorial*`)
        ...
        const alldisabledbuttons = [d_buttonRow, d_dropRow]
          if(!edited){
            edited = true;
            helpmsg.edit({content: handlemsg(client.la[ls].cmds.info.help.timeended, {prefix: prefix}), components: alldisabledbuttons}).catch((e)=>{})
          }
        });
        }  
